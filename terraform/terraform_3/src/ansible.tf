...
resource "local_file" "hosts_templatefile" {
  ...
  { 
    web = yandex_compute_instance.default,
    db  = yandex_compute_instance.database,
...
resource "null_resource" "web_hosts_provision" {
  ...
  depends_on = [yandex_compute_instance.default,yandex_compute_instance.database,yandex_compute_instance.storage]
